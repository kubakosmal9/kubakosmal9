<template>
    <a href="https://drive.google.com/uc?export=download&id=1RtOTS6uI5YSACtSp_J_b4KFGBeuuwA_I" @mouseenter="this.animateArrowEnter()" @mouseleave="this.animateArrowLeave()" @click="this.downloadCV()" class="cont">
